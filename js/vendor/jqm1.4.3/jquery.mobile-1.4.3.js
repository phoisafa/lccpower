...
$.widget( "mobile.checkboxradio", $.extend( {
	...
	_handleLabelVClick: function( event ) {
		...
		//addClasses.push(this.oncheckedClass);
...
(function( $, undefined ) {
    ...
    // pinky temp removed and replaced with below - START
    ...
    var defaultFilterCallback = function (index, searchValue) {
        ...
        var formatsearchValue = [];
        //formatsearchValue = searchValue.toUpperCase().trim().split(" ");
        formatsearchValue = searchValue.trim().split(" "); //PS
        var SearchResult = [];
        var SearchValue = "";

        for (var counter = 0; counter < formatsearchValue.length; counter++) {
            SearchValue = formatsearchValue[counter].toLowerCase();
            var item = $(this).text().toLowerCase();
            //SearchCriteria = $(this).is(':contains(' + formatsearchValue[counter] + ')');
            SearchCriteria = (item.indexOf(SearchValue) >= 0); //PS
        ...
        if (CountForTrue == formatsearchValue.length) {
            SearchCriteria = true;
        }
    ...
    // pinky temp removed and replaced with below - END
