...
app.controller("LoginCtrl", function ($scope, $http, $q, $filter, generalFunctions, DataCollectionSharedService, GeneralSharedServices, lccFunctions) {
    $scope.login = {
        emailID: "fan.phoisan@camfil.com",
        password: "Camfil@12"
    };
    $scope.infoDetails = [];
    $scope.CompanyLogo = "";
                ...
                .then(function () {
                    ...
                    .then(function (response) {
                        ...
                        if (response.data != undefined) {
                            ...
                            //DataCollectionSharedService.verifyLoginCodeFirstTime = false;
                            //DataCollectionSharedService.SessionExpired = false;
